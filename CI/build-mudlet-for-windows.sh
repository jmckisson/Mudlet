...
#  qmake ../src/mudlet.pro -spec win32-g++ "${QMAKE_OPTIONS}" "CONFIG+=debug" "CONFIG+=separate_debug_info"
  qmake6 ../src/mudlet.pro -spec win32-g++-64 "CONFIG-=qml_debug" "CONFIG-=qtquickcompiler" "CONFIG+=debug" "CONFIG+=separate_debug_info"
else
#  qmake ../src/mudlet.pro -spec win32-g++ "${QMAKE_OPTIONS}"
  qmake6 ../src/mudlet.pro -spec win32-g++-64 "CONFIG-=qml_debug" "CONFIG-=qtquickcompiler"
fi
